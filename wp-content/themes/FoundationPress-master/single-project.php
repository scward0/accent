        ...
        <div class="headline single-headline">
          ...
          <div class="navigation text-center">
            ...
            <?php
              ...
              if (!empty( $prev_post )): ?>
                <a href="<?php echo get_permalink( $prev_post->ID ); ?>"><i class="fa fa-chevron-left fa-3x" aria-hidden="true"></i></a>
              <?php endif; ?>

              <?php
              $next_post = get_next_post();
              if (!empty( $next_post )): ?>
                <a href="<?php echo get_permalink( $next_post->ID ); ?>"><i class="fa fa-chevron-right fa-3x" aria-hidden="true"></i></a>
              <?php endif; ?>
          ...
          // loop through the rows of data
            ...
            <div class="columns small-12 large-6">
              ...
              <div class="text-center">
                <div id="image-<?php echo $i ?>" class="reveal" data-reveal aria-labelledby="modalTitle" aria-hidden="true" role="dialog" style="width: 85%; top:125px">
        ...
        if( have_rows('gallery_before') ): $i = 0;
          // loop through the rows of data
            ...
            <div class="columns small-12 large-6">
              ...
              <div class="text-center">
                <div id="before-image-<?php echo $i ?>" class="reveal" data-reveal aria-labelledby="modalTitle" aria-hidden="true" role="dialog" style="width: 85%; top: 125px;">
                  <button class="close-button" data-close aria-label="Close modal" type="button">
                    <span aria-hidden="true">&times;</span>
                  </button>
                  <img src="<?php the_sub_field('image');?>"  alt="" style="display: block; margin-left: auto; margin-right: auto; padding: 20px; width: 200%;" />
