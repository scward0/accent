...
<section class="row no-max collapse" id='projects' style="padding: 0; margin: 0; background: black;">
  <br><br><br><br><br>
  <h1 class="text-center top-headline update" style="font-size: 50px; padding-bottom: 0; color: white;">PROJECTS<br><span style="border-bottom: 1px solid white; padding: 0; margin: 0; line-height: 0; font-size:16px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span></h1>
  <br><br><br><br><br>
